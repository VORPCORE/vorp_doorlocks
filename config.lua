...
Config.Doors = {
    ...
    [1988748538] = {
        ...
        BreakAble = Config.Lockpicks.ValSheriff.FrontDoor,                             -- Will use the lockpick item for this location, if false it will not use lockpick and cant be lockpicked
    ...
    [395506985]  = {
        ...
        BreakAble = Config.Lockpicks.ValSheriff.Backdoor,
        Difficulty = 3,
        Alert = true,
    },
    -- Cells
    [1508776842] = {
        ...
        DoorState = 1,
        Permissions = Config.Permissions.ValSheriff,
        BreakAble = Config.Lockpicks.ValSheriff.BackJaildoor,
        Difficulty = 3,
        Alert = true,
    },
    [193903155]  = {
        ...
        DoorState = 1,
        Permissions = Config.Permissions.ValSheriff,
        BreakAble = Config.Lockpicks.ValSheriff.Door1,
        Difficulty = 3,
        Alert = true,
    },
    [295355979]  = {
        ...
        DoorState = 1,
        Permissions = Config.Permissions.ValSheriff,
        BreakAble = Config.Lockpicks.ValSheriff.Door2,
        Difficulty = 3,
        Alert = true,
    },
    [535323366]  = {
        ...
        DoorState = 1,
        Permissions = Config.Permissions.ValSheriff,
        BreakAble = Config.Lockpicks.ValSheriff.Door3,
        Difficulty = 3,
        Alert = true,
    },
